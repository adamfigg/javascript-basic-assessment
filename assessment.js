...
// first make an array fo the keys
// second go through the keys and check if they start with an s
//if they do, change the vlaue assigned to 's'

						// var words = Object.keys(snake);

						// for (var keys in snake) {
						//   var array = keys.split("s")
						//   if (array[0] === "s") {
						//     key.push('s')
						//   }
						// }
...
var secondHero = heroes.slice(5, 1).toString();
...
// return the value from the object that corresponds to the property
					...
					// function getValueOfProperty(object) {
					// 	if (object.name = true)
					// } return object,name;
...
*/
							...
							// 	if (temperature > 80, humidity > 40) === true {
							// 		reutrn "I'm all sweat";
							// 	} if (temperature < 40, cloudiness > 60) === true {
							// 		return "I have iceicles"
							// 	} if (temperature > 80, humidity > 40, cloudiness < 20) === true {
							// 		"I'm literally in the desert"
							// 	} if (temperature > 80, (humidity > 50 === true), (cloudiness > 50 === true)) === true {
